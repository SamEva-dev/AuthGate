...
namespace AuthGate.Auth.Infrastructure.Migrations
{
    ...
    [Migration("20260130195940_AddPendingOrganizationFields")]
    partial class AddPendingOrganizationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthGate.Auth.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsFailed", "ProcessedAtUtc")
            ...
            modelBuilder.Entity("AuthGate.Auth.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("PendingOrganizationName")
                        .HasColumnType("text");

                    b.Property<string>("PendingOrganizationPhone")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AuthGate.Auth.Domain.Entities.UserOrganization", b =>
                {
                    ...
                    b.Property<string>("OrganizationDisplayName")
                        .HasColumnType("text");
